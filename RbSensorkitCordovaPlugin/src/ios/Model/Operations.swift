...
//class FetchAccDataOperation: Operation {
//    
//    var sensorsArray: [String: SensorKitDataExtractor] = [:]
...
//    
//    init(context: NSManagedObjectContext) {
//        print("\(Date().timeIntervalSince1970) FetchAccDataOperation init")
//        self.context = context
//    }
//    
//    
//    convenience init(context: NSManagedObjectContext, predicate: NSPredicate?, delay: TimeInterval? = nil) {
//        print("\(Date().timeIntervalSince1970) FetchAccDataOperation convenience init")
//        self.init(context: context)
...
//    
//    override func main() {
//        print("\(Date().timeIntervalSince1970) FetchAccDataOperation main")
//        selectSensor()
//        fetch()
//        
//        
...
//    
//    func selectSensor() {
//        print("\(Date().timeIntervalSince1970) FetchAccDataOperation selectSensor")
//
//        if ((sensorsArray["accelerometer"]) == nil) {
////            sensorsArray["accelerometer"] = AccelerometerDataExtractor(sensor: .accelerometer)
////            sensorsArray["accelerometer"] = SensorKitDataExtractor(sensor: .accelerometer)
//            sensorsArray["accelerometer"] = SensorKitDataExtractor(sensor: .ambientLightSensor)
//
//
//        }
//        selectedSensor = sensorsArray["accelerometer"]
//    }
//    
//    func fetch() {
//        print("\(Date().timeIntervalSince1970) FetchAccDataOperation fetch")
//        if (selectedSensor == nil) {
//            print("\(Date().timeIntervalSince1970) FetchAccDataOperation fetch selectedSensor is nil")
//            return
//        }
//        
//        
//        //date should be split for high frequency data
//        let fromSeconds: Double = -48 * 60 * 60
...
//        selectedSensor?.fetchData(fromDate: from, toDate: to)
//    }
//}
//
